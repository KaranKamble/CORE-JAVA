...
public class Program {
	...
	public static void print(Employee[] arr, Comparator<Employee> c) {
		if (arr != null) {
			Arrays.sort(arr, c);
	...
	public static void main(String[] args) {
		...
		Program.print(arr, new SortByJob());

		Program.print(arr, new SortByHireDate());

		Program.print(arr, new SortBySalary());

		Program.print(arr, new SortByDepartment());
